<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setting_Employee_type.aspx.cs" Inherits="BrightHRSystem.Setting_Employee_type" %>
...
<body>
    <form id="form1" runat="server" style="font-size:small">
        <div style="overflow: hidden; width:1200px;">
            ...
            <asp:Label ID="Label2" runat="server" Text="Employee type Setting" BackColor="#CC9900" 
        ...
        <div ID="DetailArea" runat="server" visible="false" style="font-size:small; width: 600px; margin-top: 10px;">
            <fieldset style="border-style:dotted;">
                ...
                <asp:Label ID="Label6" runat="server" Text="Employee type Information"></asp:Label>
                <br />
        ...
        <div style="margin-left:20px; margin-top:10px; font-size:small;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>" SelectCommand="SELECT [EMPLOYEE_TYPE], [DETAIL] FROM [TB_M_EMPLOYEE_TYPE] WHERE (([EMPLOYEE_TYPE] LIKE @EMPLOYEE_TYPE) AND ([DETAIL] LIKE @DETAIL))">
                <SelectParameters>
                    <asp:SessionParameter Name="EMPLOYEE_TYPE" SessionField="search_id" Type="String" />
