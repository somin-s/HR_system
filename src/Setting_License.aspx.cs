...
{
    public partial class Setting_License : System.Web.UI.Page
    {
        protected string s_FileType = "LicenseList";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ComFunc.Language("Setting_License.aspx", form1);
        ...
        protected void Button_Update_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckInput())
                {
                    ...
                    TB_M_LICENSE tb = db.TB_M_LICENSEs.SingleOrDefault(x =>
                        x.LICENSE_CD == ComFunc.UseSession(Page, "selected_id")
                        );
            ...
            {
                string error_msg = @"System Error E4501";
        ...
        protected void Button_Create_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataClassesDataContext db = new DataClassesDataContext();
                    TB_M_LICENSE tb = new TB_M_LICENSE
                    {
                        LICENSE_CD = TextBoxID_D.Text,
                    ...
                    db.TB_M_LICENSEs.InsertOnSubmit(tb);
                    db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4502";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected void Button_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.TB_M_LICENSEs.DeleteOnSubmit(tb);
                db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4503";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected string Generate_Report()
        {
            ...
            {
                string error_msg = @"System Error E4504";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
                return "";
            }
