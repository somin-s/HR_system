    ...
    public partial class Setting_Department : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ComFunc.Language("Setting_Department.aspx", form1);
        ...
        protected void Button_Update_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckInput())
                {
                    ...
                    TB_M_DEPARTMENT tb = db.TB_M_DEPARTMENTs.SingleOrDefault(x =>
                        x.DEPARTMENT_CD == ComFunc.UseSession(Page, "selected_id")
                        );
            ...
            {
                string error_msg = @"System Error E4101";
        ...
        protected void Button_Create_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataClassesDataContext db = new DataClassesDataContext();
                    TB_M_DEPARTMENT tb = new TB_M_DEPARTMENT
                    {
                        DEPARTMENT_CD = TextBoxID_D.Text,
                    ...
                    db.TB_M_DEPARTMENTs.InsertOnSubmit(tb);
                    db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4102";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected void Button_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.TB_M_DEPARTMENTs.DeleteOnSubmit(tb);
                db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4103";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected string Generate_Report()
        {
            ...
            {
                string error_msg = @"System Error E4104";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
                return "";
            }
