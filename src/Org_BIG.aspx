<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Org_BIG.aspx.cs" Inherits="BrightHRSystem.Org_BIG" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="xml/Org01.js"></script>
</head>
<body>
    <form id="form1" runat="server" style="font-size:small">
        <div style="overflow: hidden; width:1200px;">
            ...
            <table style="float:right;">
                <tr>
                    <td>
                        <asp:Button ID="Button_BIG" runat="server" Text="BIG" Width="80px" OnClick="Button_BIG_Click" Enabled="false"/>
