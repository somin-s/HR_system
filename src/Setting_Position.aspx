<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setting_Position.aspx.cs" Inherits="BrightHRSystem.Setting_Position" %>
...
<body>
    <form id="form1" runat="server" style="font-size:small">
        <div style="overflow: hidden; width:1200px;">
            ...
            <asp:Label ID="Label2" runat="server" Text="Position Setting" BackColor="#CC9900" 
            ...
            <div style="font-size:small; float:left; width: 950px;">
                <fieldset style="border-style:dotted;">
                    ...
                    <table border="1" cellspacing="0" cellpadding="1" style="border-collapse: collapse; float:left;">
                        <tr>
                            <td class="title01">
                                <asp:Label ID="Label3" runat="server" Text="Position CD"></asp:Label>
                            </td>
                            <td class="input01">
        ...
        <div ID="DetailArea" runat="server" visible="false" style="font-size:small; width: 600px; margin-top: 10px;">
            <fieldset style="border-style:dotted;">
                ...
                <asp:Label ID="Label6" runat="server" Text="Position Information"></asp:Label>
                <br />
                <table border="1" cellspacing="0" cellpadding="1" style="border-collapse: collapse;">
                    <tr>
                        <td class="title02">
                            <asp:Label ID="Label1" runat="server" Text="Position CD *"></asp:Label>
                        </td>
                        <td class="input01">
        ...
        <div style="margin-left:20px; margin-top:10px; font-size:small;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True" BackColor="White" BorderColor="#CC9966" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" DataKeyNames="POSITION_CD" DataSourceID="SqlDataSource1" EnableModelValidation="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="POSITION_CD" HeaderText="Position CD" ReadOnly="True" SortExpression="POSITION_CD" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HRConnectionString %>" SelectCommand="SELECT [POSITION_CD], [DETAIL] FROM [TB_M_POSITION] WHERE (([POSITION_CD] LIKE @POSITION_CD) AND ([DETAIL] LIKE @DETAIL))">
                <SelectParameters>
                    <asp:SessionParameter Name="POSITION_CD" SessionField="search_id" Type="String" />
