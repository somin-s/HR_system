...
namespace BrightHRSystem
{
    ...
    {
        protected string s_FileType = "PositionList";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ComFunc.Language("Setting_Position.aspx", form1);
        ...
        protected void Button_Update_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckInput())
                {
                    ...
                    TB_M_POSITION tb = db.TB_M_POSITIONs.SingleOrDefault(x =>
                        x.POSITION_CD == ComFunc.UseSession(Page, "selected_id")
                        );
            ...
            {
                string error_msg = @"System Error E4601";
        ...
        protected void Button_Create_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataClassesDataContext db = new DataClassesDataContext();
                    TB_M_POSITION tb = new TB_M_POSITION
                    {
                        POSITION_CD = TextBoxID_D.Text,
                    ...
                    db.TB_M_POSITIONs.InsertOnSubmit(tb);
                    db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4602";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected void Button_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.TB_M_POSITIONs.DeleteOnSubmit(tb);
                db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4603";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected string Generate_Report()
        {
            ...
            {
                string error_msg = @"System Error E4604";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
                return "";
            }
