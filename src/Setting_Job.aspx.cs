...
{
    public partial class Setting_Job : System.Web.UI.Page
    {
        protected string s_FileType = "JobList";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ComFunc.Language("Setting_Job.aspx", form1);
        ...
        protected void Button_Update_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckInput())
                {
                    ...
                    TB_M_JOB tb = db.TB_M_JOBs.SingleOrDefault(x =>
                        x.JOB_CD == ComFunc.UseSession(Page, "selected_id")
                        );
            ...
            {
                string error_msg = @"System Error E4401";
        ...
        protected void Button_Create_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataClassesDataContext db = new DataClassesDataContext();
                    TB_M_JOB tb = new TB_M_JOB
                    {
                        JOB_CD = TextBoxID_D.Text,
                    ...
                    db.TB_M_JOBs.InsertOnSubmit(tb);
                    db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4402";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected void Button_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.TB_M_JOBs.DeleteOnSubmit(tb);
                db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4403";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected string Generate_Report()
        {
            ...
            {
                string error_msg = @"System Error E4404";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
                return "";
            }
