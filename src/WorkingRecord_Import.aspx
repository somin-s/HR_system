<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkingRecord_Import.aspx.cs" Inherits="BrightHRSystem.WorkingRecord_Import" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="overflow: hidden; width:1200px;">
            ...
            <asp:Label ID="Label2" runat="server" Text="Import Working Data" BackColor="#CC99FF" 
                Width="1180px" style="font-size:large;"></asp:Label>
            <div style="margin-left:20px; margin-top:20px;">
                <asp:FileUpload ID="fu_ImportCSV" runat="server" size="100">
                </asp:FileUpload><br /><br />
                <asp:Button ID="Button_Import" runat="server" Text="Import" Height="30px" 
                    Width="100px" style="margin-left:20px; margin-top:5px;" onclick="Button_Import_Click"/>
                <asp:Button ID="Button_Upload" runat="server" Text="Upload" Height="30px" 
                    Width="100px" style="margin-left:20px; margin-top:5px;" 
                    onclick="Button_Upload_Click" OnClientClick="return confirm('Do you want to upload data to database?')"/>
                <asp:GridView ID="GridView1" runat="server" style="margin-left:20px; margin-top:20px; font-size:small;" 
