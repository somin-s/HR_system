<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Org_SMALL.aspx.cs" Inherits="BrightHRSystem.Org_SMALL" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="xml/Org03.js"></script>
</head>
<body>
            ...
            <table style="float:right;">
                <tr>
                    <td>
                        ...
                        <asp:Button ID="Button_SMALL" runat="server" Text="SMALL" Width="80px" OnClick="Button_SMALL_Click" Enabled="false"/>
                    </td>
                </tr>
            </table>
        </div>
