...
{
    public partial class Setting_Division : System.Web.UI.Page
    {
        protected string s_FileType = "DivisionList";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ComFunc.Language("Setting_Division.aspx", form1);
        ...
        protected void Button_Update_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckInput())
                {
                    ...
                    TB_M_DIVISION tb = db.TB_M_DIVISIONs.SingleOrDefault(x =>
                        x.DIVISION_CD == ComFunc.UseSession(Page, "selected_id")
                        );
            ...
            {
                string error_msg = @"System Error E4201";
        ...
        protected void Button_Create_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataClassesDataContext db = new DataClassesDataContext();
                    TB_M_DIVISION tb = new TB_M_DIVISION
                    {
                        DIVISION_CD = TextBoxID_D.Text,
                    ...
                    db.TB_M_DIVISIONs.InsertOnSubmit(tb);
                    db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4202";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected void Button_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.TB_M_DIVISIONs.DeleteOnSubmit(tb);
                db.SubmitChanges();
            ...
            {
                string error_msg = @"System Error E4203";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
            }
        }
        ...
        protected string Generate_Report()
        {
            ...
            {
                string error_msg = @"System Error E4204";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
                Page.ClientScript.RegisterStartupScript(Page.GetType(), Guid.NewGuid().ToString(), @"window.setTimeout(function(){alert('" + error_msg + "');},0);", true);
                return "";
            }
